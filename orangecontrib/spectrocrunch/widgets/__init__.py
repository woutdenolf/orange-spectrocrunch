...
WIDGET_HELP_PATH = (
    ...
    ("{}/help/orange-spectrocrunch/index.html".format(sysconfig.get_path("data")), None),
    ...
    ("http://orange-spectrocrunch.readthedocs.io/en/latest/", "")
)
